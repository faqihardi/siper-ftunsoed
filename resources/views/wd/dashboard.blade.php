<x-dashboard-layout>
    <x-slot name="title">SIPER - Dashboard WD2</x-slot>
    ...
    <div class="page active" id="dashboard-page">
        <div class="content-wrapper">
            ...
            <div class="left-panel">
                <h2 class="panel-title">Daftar Ajuan Peminjaman Aula Gedung F</h2>
    ...
    <x-slot name="scripts">
        <script>
            // Data khusus untuk Aula Gedung F
            let peminjamanData = [
                {
                    peminjaman_id: 1,
                    user_id: 1,
                    ...
                    keperluan: 'Seminar',
                    judul_kegiatan: 'Seminar Teknologi Informasi',
                    dokumen_pendukung: 'proposal_seminar.pdf',
                    tanggal_mulai: '15 Desember 2025',
                    ...
                    detail_days: [
                        {
                            detail_id: 1,
                            hari: 1,
                            tanggal_peminjaman: '15 Desember 2025',
                            jam_mulai: '08:00',
                            jam_selesai: '17:00'
                        }
                    ]
                },
                {
                    ...
                    dokumen_pendukung:  'surat_permohonan.pdf',
                    tanggal_mulai:  '20 Desember 2025',
                    tanggal_selesai: '20 Desember 2025',
                    durasi: 1,
                    status: 'pending',
                    notes: null,
                    ...
                    detail_days: [
                        {
                            detail_id:  2,
                            hari: 1,
                            tanggal_peminjaman: '20 Desember 2025',
                            jam_mulai: '13:00',
                            jam_selesai: '17:00'
                        }
                    ]
            ...
            function loadPeminjamanTable() {
                ...
                peminjamanData. forEach((item, index) => {
                    const statusClass = item.status === 'pending' ?  'status-pending' : 
                                      item.status === 'disetujui wd2' ? 'status-approved' : 
                                      'status-rejected';
                    
                    const statusText = item.status === 'pending' ? 'Menunggu' : 
                                     item.status === 'disetujui wd2' ? 'Disetujui' : 
                                     'Ditolak';
            ...
            function approvePeminjaman(peminjamanId) {
                ...
                const peminjaman = peminjamanData.find(p => p. peminjaman_id === peminjamanId);
                if (peminjaman) {
                    peminjaman.status = 'disetujui wd2';
                    loadPeminjamanTable();
